...
我的老师给我介绍了一种方法，受自身水平所限未能实现。思路分享如下：构图，图中有两类节点，一类是词节点一类是句节点。句节点与句中词节点相连，在句节点之间设置一种相似度度量方法作为loss function，然后用GNN的方法训练，不断更新每个节点的隐藏状态。这是一种区别于lgb和esim的新方法，应该会有不错的效果。但是如何对训练集中未出现的词进行表示也一直是我在思考的问题。
